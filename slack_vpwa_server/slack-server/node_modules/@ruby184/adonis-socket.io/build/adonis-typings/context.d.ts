...
declare module '@ioc:Ruby184/Socket.IO/WsContext' {
     ...
     */
    export interface WsContextContract extends Omit<HttpContextContract, 'response' | 'route' | 'subdomains'> {
        socket: WsSocket;
    ...
    export interface WsContextConstructorContract extends HttpContextConstructorContract {
        new (request: RequestContract, response: ResponseContract, logger: LoggerContract, profiler: ProfilerRowContract, socket: WsSocket): WsContextContract;
    }
