...
declare module '@ioc:Ruby184/Socket.IO/Ws' {
    ...
    import { FunctionMiddlewareHandler, WsMiddlewareStoreContract } from '@ioc:Ruby184/Socket.IO/MiddlewareStore';
    import { IocResolverLookupNode } from '@ioc:Adonis/Core/Application';
    import { RouteParamMatcher, RouteMatchersNode, RouteMatchersContract } from '@ioc:Adonis/Core/Route';
    ...
    export type NamespaceNode = {
        ...
        meta: {
            resolvedHandlers?: {
                [Key in keyof NamespaceHandlers]: ResolvedHandler<Exclude<NamespaceHandlers[Key], undefined>> | undefined;
            };
    ...
    export interface WsNamespaceConstructorContract extends MacroableConstructorContract<WsNamespaceContract> {
    ...
    export interface NamespaceMatchersConstructorContract extends MacroableConstructorContract<NamespaceMatchersContract> {
